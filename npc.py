...
class CyberDemonNPC(NPC):
    def __init__(self, game, path='resources/sprites/npc/cyber_demon/0.png', pos=(11.5, 6.0),
        ...
        super().__init__(game, path, pos, scale, shift, animation_time)
        self.attack_dist = 6
        self.health = cyberDemonHealth
        self.attack_damage = 20
        self.speed = 0.055
        self.accuracy = 0.25

class ImpNPC(NPC):
    def __init__(self, game, path='resources/sprites/npc/imp/0.png', pos=(10.5, 8),
                 scale=0.7, shift=0.27, animation_time=250):
        super().__init__(game, path, pos, scale, shift, animation_time)
        self.attack_dist = 1.0
        self.health = 100
...
class DemonNPC(NPC):
    def __init__(self, game, path='resources/sprites/npc/demon/0.png', pos=(10.5, 8),
                 scale=0.7, shift=0.27, animation_time=250):
        super().__init__(game, path, pos, scale, shift, animation_time)
        self.attack_dist = 1.0
        self.health = 100
